...
როდესაც პროექტს გადაიტანთ სხვა კომპიუტერზე ან GitHub-ზე, environment variables არ არის დაყენებული, რის გამოც agents არ მუშაობს სწორად.

When you move the project to another computer or GitHub, environment variables are not set, causing agents to not work correctly.
...
გამოიყენეთ setup script environment variables-ის დასაყენებლად:
...
იტვირთება environment variables .env ფაილიდან:
...
3. გამოიყენეთ `load_environment.ps1` script
   Use `load_environment.ps1` script
